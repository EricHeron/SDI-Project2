...
// Variable Scope demonstrated here		
		var freeTime = function(work, play) {
			console.log("Movies are great after " + work + ", " + play + " is way more fun!");
			var eatFood = function (eat, play) {
				console.log("They ate " + eat + " after the movie, then they continued to " + play + ".");
			}
			eatFood("Pizza", "relax");
			console.log("They returned home after that");
		}
		freeTime("cleaning", "relaxing");
	}
